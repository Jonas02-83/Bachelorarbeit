...
\input{ETTI6_TL_Lite}          % Laden aller notwendigen Pakte und Definitionen	
\usepackage{tabu} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\theCourseOfStudies{Wehrtechnik - Informations- und Elektrotechnik}
\def\theCertificate{Bachelorarbeit}
\def\theTitle{Einsatz von LLM Tools im Software Engineering Prozess}
\def\theSubTitle{}
\def\theAuthor{Jonas Gundlach}
\def\theAdviserA{Prof. Dr. rer. nat. Andrea Baumann}
\def\theAdviserB{~}
\def\thePublicationDate{XX.XX.XXXX}
\def\thePublicationMY{Juli 2024}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Titelseite
\include{source/000_title}
\include{source/001_declaration}
...
\include{source/100_introduction}
\include{source/200_basics}
\include{source/300_usage}
\include{source/400_comparison}
\include{source/500_Problems}
\include{source/600_Conclusion}
