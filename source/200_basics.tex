...
Im ersten Kapitel wird erläutert, was LLM Tools sind, wie sie trainiert werden und wie sie funktionieren. Anschließend 
werden die einzelnen Tools, die in dieser Arbeit betrachtet werden, vorgestellt und deren Entwicklung beschrieben.\\

Im zweiten Teil des Kapitels wird auf die einzelnen Dokumente, die während des Software Engineering Prozesses 
erstellt werden, näher eingegangen und es wird festgelegt, welche Dokumente und Abschnitte in der Analyse 
betrachtet werden. Dadurch, dass sich die Arbeit bei der Erstellung der Dokumente an das Modul ``Secure 
Software Engineering'' orientiert, werden einige Kapitel und Abschnitte nicht betrachtet. Daher wird bei 
der Beschreibung der Dokumente ohne Begründung erwähnt, dass diese im folgenden nicht richtig betrachtet werden.
Der Vollständigkeit wegen, werden diese aber trotzdem hier im Grundlagen Kapitel aufgelistet.
...
\begin{figure}
    \centering
    \includegraphics{pictures/Kapitel2Tabelle.PNG}
...
Grundsätzlichen würden hier noch drei Abschnitte kommen, welche hier allerdings nicht weiter betrachtet werden:
Zum einen wird beschrieben, ob das Projekt besondere Softwarelizenzen benötigt. Nachfolgend gibt es ein 
Abschnitt zu Sicherheit wo beschrieben wird, wie mit Sicherheitsaspekten wie Backup, Zugangskontrollen 
und Verschlüsselungen umgegangen wird. Als letztes gibt es ein Abschnitt für Sonstige Spielregeln.
...
betrachtet.\\
Das Kapitel würde sich der Planung widmen und behandelt verschiedene Planungsaspekte. Der erste Abschnitt befasst 
...
Anschließend werden die Benutzeranforderungen definiert, welches aber ebenfalls nicht betrachtet wird. 
...
durch ihre Eigenschaften. Entitätentypen besitzen Attribute und Beziehungen, jedoch keine Fähigkeiten. Das fachliche 
...
Die Beschreibung eines Anwendungsfalls hat mehrere Bestandteile: Der Titel dient als eindeutige Identifikation, die Kurzbeschreibung 
...
Aktionen für jeden Button. Die Benutzungsschnittstelle stellt dar, wie die Dialoge miteinander verbunden sin.\\
...
Die Benutzungsschnittstelle kann eine beliebige Darstellungform sein.
...
Der Inhalt des Architekturdokuments gliedert sich in drei Hauptabschnitte: die Technische Architektur, Anwendungsarchitektur 
und IT-Konzept.\\
...
entweder durch ein UML-Komponenten-Diagramm oder Entity-Relationship-Diagramme dargestellt. Aber auch dieses wird hier 
