...
\begin{abstract}
    ...
    Engineerings eingesetzt werden können. Dabei wird betrachtet, wie gut die drei Tools in der Lage sind, die in einem Software-Engineering-Prozess 
    ...
    die Tools im Rahmen eines Software-Engineering-Prozesses unterstützen können. Da es zahlreiche Unterstützungsmöglichkeiten gibt, wird sich in 
    dieser Arbeit lediglich auf die Dokumentenerstellung fokussiert.
